...
class ItemDescription extends Component {
  constructor() {
    ...
    this.item = {
      ...
      imageUrl:
        "https://5.imimg.com/data5/EX/PC/MY-51545753/selection_587-500x500.png",
  ...
  render() {
    return (
      ...
      >
        ...
        <Text mt="25px" fontSize="13px" color="grey">
          name
        </Text>
        <Text mt="17px" fontSize="22px">
          {this.item.name}
        </Text>
        <Text mt="30px" fontSize="13px" color="grey">
          category
        </Text>
